...
func TestReader(t *testing.T) {
	t.Run("successfully publishes message", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("publishes messages in order", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("does not pick messages scheduled in the future", func(t *testing.T) {
		dbCtx := setupTest(t)
...
func TestReaderRetries(t *testing.T) {
	t.Run("retries failed publish and retains message", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("publish error contains correct times attempted", func(t *testing.T) {
		dbCtx := setupTest(t)
...
func TestReaderTimeouts(t *testing.T) {
	t.Run("times out when reading messages takes too long", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("times out when publishing messages takes too long", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("times out when deleting messages at end of batch takes too long", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("times out when deleting messages during batch iteration takes too long", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("times out when updating messages takes too long", func(t *testing.T) {
		dbCtx := setupTest(t)
...
func TestReaderLifecycle(t *testing.T) {
	t.Run("stop times out if reader is gracefully stopped", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("stop cancels in progress publishing", func(t *testing.T) {
		dbCtx := setupTest(t)
...
func TestReaderChannels(t *testing.T) {
	t.Run("discards errors if buffer is full", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("drops discarded messages when channel is full", func(t *testing.T) {
		dbCtx := setupTest(t)
...
func TestReaderBatching(t *testing.T) {
	t.Run("deletes messages in batches", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("deletes all published messages after iteration even if batch size is not reached", func(t *testing.T) {
		dbCtx := setupTest(t)
...
func TestReaderDiscardedMessages(t *testing.T) {
	t.Run("discards message after max attempts", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("discards message after optimistic publish failure", func(t *testing.T) {
		dbCtx := setupTest(t)
...
func TestReaderDelayStrategies(t *testing.T) {
	t.Run("retries with fixed delay", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("retries with exponential delay", func(t *testing.T) {
		dbCtx := setupTest(t)
	...
	t.Run("retries with custom delay func", func(t *testing.T) {
		dbCtx := setupTest(t)
